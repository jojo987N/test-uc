...
export const Icon = ({ name, type, size }) => {
  return (
    <>
      {type === "AntDesign" ? (
        <AntDesign name={name} size={size ? size : 24} color="black" />
      ) : (
        <></>
      )}
      {type === "Ionicons" ? (
        <Ionicons name={name} size={size ? size : 24} color="black" />
      ) : (
        <></>
      )}
      {type === "FontAwesome" ? (
        <FontAwesome name={name} size={size ? size : 24} color="black" />
      ) : (
        <></>
      )}
      {type === "MaterialIcons" ? (
        <MaterialIcons name={name} size={size ? size : 24} color="black" />
      ) : (
        <></>
      )}
      {type === "Entypo" ? (
        <Entypo name={name} size={size ? size : 24} color="black" />
      ) : (
        <></>
      )}
    </>
