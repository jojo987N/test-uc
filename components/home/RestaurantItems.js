  ...
  return (
    <View style={{}}>
      <FlatList
        ...
        data={
          props.reward
            ? props.restaurantData.filter(
                (restaurant) => restaurant.reward === props.reward
              )
            : props.ads
            ? props.restaurantData.filter((restaurant) => restaurant.ads)
            ...
            >
              ...
              >
                <View>
                  ...
                  {props.reward || item.reward ? (
                    <Reward restaurant={item} />
                  ) : (
                    <></>
                  )}
                  {props.ads && (
                    <Affiche ads={item.ads} adsColor={item.adsColor} />
                  )}
                </View>
                <RestaurantInfo
    ...
    <View style={styles.container}>
      <View style={{ ...styles.container1, backgroundColor: props.adsColor }}>
        <Text
          style={{
            ...styles.text,
            color: props.adsColor === "#800000" ? "white" : "black",
          }}
        >
          {props.ads}
        </Text>
