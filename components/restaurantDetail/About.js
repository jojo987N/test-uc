...
export default function About(props) {
  ...
  const { name, image_url, price, review_count, rating, collectTime } =
    restaurant;
  ...
  useEffect(() => {
    getCategoriesFromRestaurant(restaurant.restaurantId).then((categories) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <RestaurantDetailComponent
        ...
        visible={restaurantDetail}
        setVisible={setRestaurantDetail}
...
export const RestaurantDescription = (props) => (
  <View style={styles.description}>
    <Text style={props.style ? { ...props.style } : styles.textDescription}>
      {props.description}
    </Text>
  </View>
);
