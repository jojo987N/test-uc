...
import { StyleSheet, Text, View,ScrollView,TextInput,Alert, SafeAreaView, StatusBar} from 'react-native'
...
async function signUp(values){
 ...
 const {email,password,name,phone_number} = values

  try{
    const userCredentials = await createUserWithEmailAndPassword(auth, email, password)

    addUser(userCredentials,name,phone_number)
                            ...
                            <View>
                               ...
                               <View style ={styles.view6}>
                                  <TextInput 
                                    ...
                                    onChangeText = {(text)=>setValues({...values, phone_number:text})}
                                  />
                               </View>
                               <View style ={styles.view6}>
                                  <TextInput 
