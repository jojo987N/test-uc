      ...
      {items.length === 0 ? (
        ...
        >
          <Image
            ...
            source={{
              uri: "https://img.icons8.com/fluency/344/shopping-cart.png",
            }}
          />
          <Text style={{ fontSize: 20 }}>Add items to start a cart</Text>
          <Text style={{ fontSize: 10, marginBottom: 15 }}>
            Once you add items from a restaurant or store, your card will appear
            here
          </Text>
          <TouchableOpacity
          ...
          >
            <Text style={{ color: "white", padding: 8, paddingHorizontal: 10 }}>
              Start shopping
            </Text>
          </TouchableOpacity>
        </View>
          ...
          {Object.entries(
            ...
            >
              ...
              <View style={styles.name_quantity_price}>
                ...
                <Text style={styles.quantity_price}>
                  {quantity} article{quantity > 1 ? "s" : ""} •{" "}
                  {items
                    .reduce(
                      (a, v) =>
                        v.restaurantName === restaurantName ? a + v.price : a,
                      0
                    )
                ...
                <Text style={styles.address}>
                  deliver to {address.description}
                </Text>
              </View>
